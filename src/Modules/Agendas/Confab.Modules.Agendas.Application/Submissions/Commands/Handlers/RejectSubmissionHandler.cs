...
namespace Confab.Modules.Agendas.Application.Submissions.Commands.Handlers
{
    public sealed class RejectSubmissionHandler : ICommandHandler<RejectSubmission>
    {
        ...
        public RejectSubmissionHandler(ISubmissionRepository submissionRepository, IDomaintEventDispatcher domaintEventDispatcher, IEventMapper eventMapper, IMessageBroker messageBroker)
        {
